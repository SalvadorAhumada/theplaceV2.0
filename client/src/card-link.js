...
function CardLink(props) {
   ...
   useEffect(() => {
    ...
    const isFavorite = fav.fav ? <div onClick={()=>props.onClick(props.unit.name, 'deleted')}><Favorite/></div> : <div onClick={()=> props.onClick(props.unit.name, 'saved')}> <FavoriteBorder/></div>
